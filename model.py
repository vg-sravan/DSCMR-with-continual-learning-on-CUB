...
class VGGNet(nn.Module):
    def __init__(self):
        ...
        self.avgpool = self.vgg.avgpool  # comment
...
class IDCM_NN(nn.Module):  # main model class
    """Network to learn text representations"""

    def __init__(self, img_input_dim=4096, img_output_dim=2048,
                 text_input_dim=1024, text_output_dim=2048, minus_one_dim=1024, output_dim=200):
    ...
    def forward(self, img, text):
        img1 = self.vgg_net(img)
        view1_feature = self.img_net(img1)
